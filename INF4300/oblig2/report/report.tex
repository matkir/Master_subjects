...
\newpage
	\begin{figure}[h]%
		\centering
    	\subfloat[Texture 4]{{\includegraphics[width=12.5cm]{o1_f4.jpg} }}%
...
The Q matrices can now be analyzed: \\
	\begin{figure}[h]%
		\centering
    	\subfloat[Texture 4]{{\includegraphics[width=12.5cm]{o3_q1.jpg} }}%
    	\caption{Texture 4 GLCM}%
    	\label{fig:o1_f4}%
	\end{figure}
	...
	\begin{figure}[h]%
		\centering
    	\subfloat[Texture 4]{{\includegraphics[width=12.5cm]{o3_q4.jpg} }}%
    	\caption{Texture 4 GLCM}%
    	\label{fig:o1_f4}%
	\end{figure}
	...
	\begin{figure}[h]%
		\centering
    	\subfloat[Texture 4]{{\includegraphics[width=12.5cm]{o3_q12.jpg} }}%
    	\caption{Texture 4 GLCM}%
    	\label{fig:o1_f4}%
	\end{figure}
...
\section{Multivariate Gaussian Classifier}
	...
	\begin{center}
		$y = f( x , \mu , \sum)=\frac{1}{\sqrt{|\sum|(2\pi)^{d}}}exp\left(-\frac{1}{2}(x-\mu)\sum^{-1}(x-\mu)'\right)$
	\end{center}
\newpage
